...
<style>
	*{
	...
	#grid {
			background:url('<?php echo get_template_directory_uri(); ?>/assets/js/_lib/mapbox/assets/grid.png');
			width:100%;
			height:100%;
			position:absolute;
	...
	<div id='compass' onclick='updateCompass(true)'>
		<img src='<?php echo get_template_directory_uri(); ?>/assets/js/_lib/mapbox/assets/compass.svg' width='28'>
	</div>
	...
	<script src="../wp-content/uploads/mapbox/libs/sm.js" note='THIS WAS MODIFIED TO PROJECT TO DECIMAL PIXELS'></script>

	<script src="../wp-content/uploads/mapbox/libs/utilities.js"></script>
	<script src="../wp-content/uploads/mapbox/components/sidebar.js"></script>
	<script src="../wp-content/uploads/three/build/three.min.js"></script>
	<script src="../wp-content/uploads/mapbox/libs/app.js"></script>
	<script src="../wp-content/uploads/mapbox/libs/OrbitControls.js"></script>
   ...
   function assembleUrl(img, coords){
       ...
       //return 'sample.png'
       return 'https://'+server+'.tiles.mapbox.com/v4/'+tileset+'/'+slashify(coords)+res+'?access_token=pk.eyJ1Ijoib3pwb28iLCJhIjoicmRMbmhHayJ9.2Ej3FH8CTV9bvARvCRvDiQ'
   }
   ...
   var updater = new Worker('<?php echo get_template_directory_uri(); ?>/assets/js/_lib/mapbox/workers/updatetile.js');
   ...
   for (var p=0; p<4; p++){
       var parser = new Worker('<?php echo get_template_directory_uri(); ?>/assets/js/_lib/mapbox/workers/parseelevationworker.js');
